  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col justify-center px-6 py-16">
      ...
      <h1 className="max-w-3xl text-5xl font-semibold tracking-tight text-zinc-50">
        Stripe Checkout surface for one-time payments.
      </h1>
      <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
        Create hosted checkout sessions, redirect customers to Stripe, receive webhook events, and
        track local payment state, ledger entries, and checkout status.
      </p>
